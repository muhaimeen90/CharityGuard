...
export default function CampaignDetailsPage() {
  ...
  const handleViewCampaignTitle = () => {
    router.push(`/campaign-report/${campaign.id}`);
  };
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        <div className="flex-[2] flex flex-col gap-[40px]">
          ...
          <div className="flex flex-col lg:flex-row gap-5">
            {/* Right Section - Fund Section */}
            <div className="flex-1 p-4 bg-[#1c1c24] rounded-[10px]">
              ...
              {/* Analytics Button */}
              <div className="mt-[20px] p-4 bg-[#1c1c24] rounded-[10px] flex items-center justify-center">
                <CustomButton
                  btnType="button"
                  title="Analytics"
                  styles="w-full bg-[#4acd8d]"
                  handleClick={handleViewCampaignTitle}
                />
              </div>
            </div>
          </div>
